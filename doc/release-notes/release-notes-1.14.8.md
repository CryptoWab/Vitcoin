Vitcoin Core version 1.14.8 is now available from:

  <https://github.com/vitcoin/vitcoin/releases/tag/v1.14.8/>

This is a new minor version release. Vitcoin users on any platform are
...
Several important updates have been added to Vitcoin Core, including fixes
backported from Bitcoin Core's upstream.

### Reduce Peer INV Object Counts

Previously, Vitcoin Core nodes would maintain a large list of inventory for
...
A new transaction request tracking system improves the way Vitcoin Core
...
In previous versions of Vitcoin Core, orphan transactions were processed in a
...
Vitcoin Core now sends a getheaders message for one block when announced in an
...
vulnerability or security issue in Vitcoin Core.
...
* Vitcoin Core now supports compilation with C++14 and C++17, if you select
