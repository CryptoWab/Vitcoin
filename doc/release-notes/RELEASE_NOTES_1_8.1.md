...
Vitcoin Core 1.8.1 is primarily a bugfix release, bringing Vitcoin Core in
line with Bitcoin 0.9.3. Vitcoin Core 1.8.1 also adds in support for printing
...
## Vitcoin Core Release Notes

* Translation improvements and corrections
* Disable Transifex based translation process (not used by Vitcoin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 Vitcoin Core clients
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/vitcoin/vitcoin/issues/134).
