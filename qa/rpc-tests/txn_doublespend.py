...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 7,500,000 VTC:
        ...
        # First: use raw transaction API to send 7440000 VTC to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 500,000 VTC for another
        ...
        # Node0's total balance should be starting balance, plus 1000000 VTC for 
