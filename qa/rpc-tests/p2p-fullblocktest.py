...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure vitcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure vitcoind isn't accepting b28
        ...
        #
        # Vitcoin: Currently this causes a node disconnect, and I'm not even sure that's wrong.
