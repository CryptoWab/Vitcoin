# Contributing to Vitcoin Core

Vitcoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/vitcoin/vitcoin/labels/help%20wanted)
* [Projects](https://github.com/vitcoin/vitcoin/projects)
* [Vitcoindev on reddit](https://www.reddit.com/r/vitcoindev/)

## Branch Strategy

Vitcoin Core's default branch is intentionally a stable release, so that anyone
...
Vitcoin Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Vitcoin Core
releases will automatically benefit from these.

When refactoring Vitcoin-specific code, please keep refactoring requests short,
...
The following applies to code changes to Vitcoin Core, and is not to be
confused with overall Vitcoin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Vitcoin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Vitcoin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Vitcoin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Vitcoin consensus, it must have been
