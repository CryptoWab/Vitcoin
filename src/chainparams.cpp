...
public:
    CMainParams() {
        ...
        // ================================================================
        // LOW DIFFICULTY SETTINGS FOR CUSTOM GENESIS
        // ================================================================
        consensus.powLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // Lowest difficulty limit
        ...
        // ================================================================
        // HARDCODED GENESIS BLOCK VALUES (LOW DIFFICULTY)
        // ================================================================
        
        // Genesis parameters with LOW difficulty
        uint32_t nTime = 1784119840;
        uint32_t nNonce = 2;
        uint32_t nBits = 0x207fffff; // Lowest possible difficulty
        int32_t nVersion = 1;
        const CAmount genesisReward = 88 * COIN;
        ...
        consensus.hashGenesisBlock = uint256S("0x211d3b564919e5a90d2070c7799806b8e2dd3c5262fc08f47eaf39c577bcf3a9");
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        
        // Merkle root is already set by CreateGenesisBlock
        // but we confirm it matches our expected value
        // genesis.hashMerkleRoot = uint256S("0x5b2a3f53f605d62c53e62932dac6925e3d74afa5a4b459745c36d42d0ed26a69");
        
        // Note that of those with the service bits flag, most only support a subset of possible options
        // ================================================================
        // DNS SEEDS DISABLED - Prevent connecting to external nodes
        // ================================================================
        ...
        // CHECKPOINTS DISABLED - Important for custom genesis
...
public:
    CTestNetParams() {
        ...
        // DNS SEEDS DISABLED for testnet
        vSeeds.clear();
...
public:
    CRegTestParams() {
        ...
        // DNS SEEDS DISABLED for regtest
