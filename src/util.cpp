...
const char * const BITCOIN_CONF_FILENAME = "vitcoin.conf";
const char * const BITCOIN_PID_FILENAME = "vitcoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Vitcoin";
#else
    // Unix
