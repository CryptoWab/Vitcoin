...
// Copyright (c) 2021-2025 The Vitcoin Core developers
...
static UniValue AuxMiningCreateBlock(const CScript& scriptPubKey)
{
     ...
     * a single vitcoind instance, for example when a pool runs multiple sub-
