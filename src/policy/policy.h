...
/** Recommended transaction fee by Vitcoin Core developers
  *
 ...
 *
 *  Vitcoin:    Increment mempool limits and accept RBF in steps of 0.0001 VTC
...
/**
 * Vitcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Vitcoin: Default hard dust limit that is evaluated when considering whether
