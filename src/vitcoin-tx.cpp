...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vitcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vitcoin transaction") + "\n" +
              "  vitcoin-tx [options] -create [commands]   " + _("Create hex-encoded vitcoin transaction") + "\n" +
              "\n";
