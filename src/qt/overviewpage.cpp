...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Vitcoin Core repository on GitHub"),
        tr("Services that claim to double your vitcoins are always ponzi schemes")
    };
