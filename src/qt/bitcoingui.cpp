    ...
    platformStyle(_platformStyle)
{
    ...
    // Vitcoin: load fallback font in case Comic Sans is not available on the system
    ...
    // Vitcoin: load this bundled font for Settings -> Options in case it's not available on the system
    ...
    // Vitcoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Vitcoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vitcoin: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a vitcoin: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a Vitcoin private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Vitcoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Vitcoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
